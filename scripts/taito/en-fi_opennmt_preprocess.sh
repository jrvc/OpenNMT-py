...
python $SRCDIR/preprocess.py -train_src $INDIR/train/train.en -train_tgt $INDIR/train/train.fi -valid_src $INDIR/dev/dev.en -valid_tgt $INDIR/dev/dev.fi -save_data $OUTDIR/en-fi -shard_size 1000000 -src_seq_length 500 -tgt_seq_length 500
